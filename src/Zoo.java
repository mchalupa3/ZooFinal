...
public class Zoo
{
    ...
    public static String lookUp(List<Animal> animals)
    {
        ...
        for(Animal a : animals)
            {
            if(a instanceof animal_qualities.Flying)
            {
                animal_qualities.Flying f = (animal_qualities.Flying) a;
                msg += a.getName() + ": \n       "
                + f.fly() + "\n";
            }
        }
    ...
    public static void populateAnimals(List<Animal> animals)
    {
        ...
        Parrot mikey = new animals.Parrot();
        animals.add( mikey );
        animals.add( george );
        Alligator chase = new Alligator();
        animals.add(chase );
        Parrot squwaky = new Parrot();
        animals.add(squwaky);
        Orangutan kyle = new Orangutan();
        animals.add( kyle );
